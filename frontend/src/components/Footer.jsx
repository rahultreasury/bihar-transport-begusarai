      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-gray-400">Truck Transport</span></li>
              <li><span className="text-gray-400">Mini Truck Services</span></li>
              <li><span className="text-gray-400">Pickup Services</span></li>
              <li><span className="text-gray-400">Tempo Services</span></li>
              <li><span className="text-gray-400">Local Delivery</span></li>
            </ul>
          </div>
        </div>
      </div>
